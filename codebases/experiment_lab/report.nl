...
types:
  ...
  Trial: '{ candidate: Text, case_id: Text, attempt: Num, status: "done" | "quiesced" | "exception" | "missing", conflict: "merged" | "unresolved" | "rejected" | "unknown", provenance: Bool, quality: "pass" | "fail" | "pending", value_digest: Text, trace_id: Text }'
