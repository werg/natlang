...
returns: Draft
---
Consider `current/text`, every prior applied update and every unresolved alternative.
Interpret the new update's intent under `policy` and the agreed `base`. Return a
