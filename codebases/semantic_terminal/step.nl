...
---
description: Reduce one user or job event in a semantic terminal session. For a request about this workspace, inspect the relevant leaf under files (for example files/README.md/text) before selecting a recipe; pass the lazy dictionary only to children that need it.
args:
  acc: Session
  item: Event
