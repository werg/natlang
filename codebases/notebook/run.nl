...
---
description: Execute the declared notebook cell graph and interpret bounded results. If the question names a supporting note or schema, inspect that specific files leaf before answering.
args:
  goal: string
  question: string
