...
TS-style type language. Keep the exact parameter names. State uncertain alternatives
instead of inventing a type from one example. Effects must include the required effects
