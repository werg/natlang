...
returns: Judgement
---
Judge this event using the supplied exact log evidence. If the event names a local runbook or log file, inspect only that files leaf before judging it. Choose action
