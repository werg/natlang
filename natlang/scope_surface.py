            ...
            _tool("read_value", "Inspect a variable or a field/index selection without executing code.",
                  {"expression": {"type": "string"},
                   "start": {"type": "integer", "minimum": 0,
                             "description": "Zero-based character offset for Text or item index for a list."},
                   "end": {"type": "integer", "minimum": 0,
                           "description": "Exclusive character or item offset, as in JavaScript slice()."}}, ["expression"]),
